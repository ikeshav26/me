...
const projects: Project[] = [
  ...
  },
  {
    title: 'Keep-Awake',
    description:
      'An npm package to keep free-tier servers awake via cron-based pinging.',
    longDescription:
  ...
  },
  {
    title: 'Echovia',
    description:
      'A full-featured music streaming platform with genre browsing, playlist management, and a sleek now-playing experience.',
    longDescription:
  ...
  },
  {
    ...
    description:
      'A premium, interactive developer portfolio featuring smooth scrolling, dynamic animations, and optimal performance.',
    longDescription:
  ...
  },
  {
    title: 'Fit-AI',
    description:
      'A web application that predicts diseases from symptoms using machine learning, providing a user-friendly diagnostic interface.',
    longDescription:
  ...
  },
  {
    title: 'CI-Tool',
    description:
      'An auto AI reviewer that automatically reviews pull requests using Gemini AI, integrated seamlessly with GitHub Actions.',
    longDescription:
  ...
  },
  {
    title: 'ZettaNote',
    description:
      'An open-source Notion alternative — a rich, collaborative note-taking platform with real-time sync and sharing.',
    longDescription:
...
const Work = () => {
  ...
  return (
    <div className="min-h-screen pt-18 pb-20 px-6 max-w-7xl mx-auto">
      ...
      >
        <h1
          className={`text-5xl md:text-7xl font-bold font-['Oswald'] ${theme === 'dark' ? 'text-white' : 'text-black'} mb-6 tracking-tight`}
        >
          SELECTED <span className="text-orange-300">WORKS</span>
        </h1>
        <p
          className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} font-['JetBrains_Mono'] max-w-2xl mx-auto text-lg leading-relaxed`}
        >
          Showcasing a collection of projects where design meets functionality.
          Focused on creating performant, interactive, and premium user
          experiences.
        </p>
      </motion.div>
