...
interface DecryptedTextProps extends HTMLMotionProps<'span'> {
  ...
  animateOn?: 'view' | 'hover' | 'inViewHover' | 'click' | 'load' | 'repeat';
...
export default function DecryptedText({
  ...
  useEffect(() => {
    if (animateOn === 'click' || animateOn === 'load' || animateOn === 'repeat') {
      encryptInstantly();
    } else {
      setDisplayText(text);
      setIsDecrypted(true);
  ...
  useEffect(() => {
    ...
    } else if (animateOn === 'repeat') {
      intervalId = setInterval(() => {
        encryptInstantly();
        // Give a tiny moment for encryption to show before starting decryption
  ...
  }, [animateOn, delay, triggerDecrypt, encryptInstantly]);
