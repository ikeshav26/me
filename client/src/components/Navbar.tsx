      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-[72px] right-4 w-56 backdrop-blur-2xl rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.3)] z-90 overflow-hidden md:hidden flex flex-col p-2 gap-1"
            style={{
              background:
            ...
            {routes.map((route, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="font-['JetBrains_Mono'] tracking-tight text-lg">
                      {route.label}
                    </span>
                    {isActive && (
